    ...
    <div>
      <div className="flex items-center justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage your curry and food menu (Realtime + file uploads)</p>
        </div>
        <Button onClick={() => setEditing({ name: "", price: 0, category: "Signature Curry", spice_level: 0, description: "", image_url: "", featured: false })}>
          Add Item
        </Button>
      </div>
        ...
        <div className="mt-6 rounded-2xl border border-border bg-card p-6">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Select value={editing.category ?? "Signature Curry"} onChange={(e) => setEditing({ ...editing, category: e.target.value })} className="mt-1">
